 ...
 * 2017-09-26T09:48:10.373-03:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "WSCartolasCRV", 
                  wsdlLocation = "file:/C:/Sandbox/SVirtual/wspace10.4/bicevida-sucursalvirtual-rentasvitalicias-middleware/bv-rentasvitalicias-mid-credivida/src/main/resources/wsdl/cartola.wsdl",
...
public class WSCartolasCRV_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Sandbox/SVirtual/wspace10.4/bicevida-sucursalvirtual-rentasvitalicias-middleware/bv-rentasvitalicias-mid-credivida/src/main/resources/wsdl/cartola.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WSCartolasCRV_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Sandbox/SVirtual/wspace10.4/bicevida-sucursalvirtual-rentasvitalicias-middleware/bv-rentasvitalicias-mid-credivida/src/main/resources/wsdl/cartola.wsdl");
        }
        WSDL_LOCATION = url;
    }
