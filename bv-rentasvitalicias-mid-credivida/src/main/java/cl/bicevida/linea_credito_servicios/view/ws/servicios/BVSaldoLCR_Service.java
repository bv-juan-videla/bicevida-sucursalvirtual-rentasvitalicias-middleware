 ...
 * 2017-09-26T09:51:54.808-03:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "BV_SaldoLCR", 
                  wsdlLocation = "file:/C:/Sandbox/SVirtual/wspace10.4/bicevida-sucursalvirtual-rentasvitalicias-middleware/bv-rentasvitalicias-mid-credivida/src/main/resources/wsdl/saldo.wsdl",
...
public class BVSaldoLCR_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Sandbox/SVirtual/wspace10.4/bicevida-sucursalvirtual-rentasvitalicias-middleware/bv-rentasvitalicias-mid-credivida/src/main/resources/wsdl/saldo.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BVSaldoLCR_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Sandbox/SVirtual/wspace10.4/bicevida-sucursalvirtual-rentasvitalicias-middleware/bv-rentasvitalicias-mid-credivida/src/main/resources/wsdl/saldo.wsdl");
        }
        WSDL_LOCATION = url;
    }
